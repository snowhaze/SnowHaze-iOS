...
var readability = {
    ...
    init: function() {
        ...
        if(!articleContent) {
            ...
            articleContent.innerHTML = "<p>Sorry, Reader view could not be generated for this page</p><p>Please note that Reader view does not work well on front pages. It is intended for articles with large blocks of text. If you're using Reader mode on a landing page, please open an article first before enabling Reader mode.</p>";
		...
		var readStyle = "";document.body.className = readStyle; // Changed: added var readStyle = "";
        ...
        var readMargin = "";var readSize = "";innerDiv.className    = readMargin + " " + readSize; // Changed: added var readMargin = "";var readSize = "";
